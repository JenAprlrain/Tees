     ...
     const content = (
       ...
       <br />
        ...
        collections on Ethereum and Fantom. She has received accolates including 2021 Artist of the
         ...
         highest-volume collections to date on the Fantom blockchain. OfficialNFTees had the 
         pleasure of collaborating with Uman on an 11-piece sub-collection of the original Royal 
 ...
 return (
    ...
    const TOAModal = () => {
      ...
      const content = (
        ...
        artists to date. TEES has been working on a collaboration with TOA to bring TOA 
        collectors favorite NFTs to life in physical apparel. Release date to be announced.
            </div>
            <br />
        </>
      );
  ...
  return (
     ...
     const ClokkModal = () => {
      ...
      const content = (
        ...
        auctions to date. OfficialNFTees has partnered with Clokkworky on vibrant, three piece 
        ...
        designs are planned with a TBD drop date.
            </div>
            <br />
        </>
      );
  ...
  return (
     ...
     const PotluckModal = () => {
      ...
      const content = (
        ...
        HBAR), and continues to expand its reach for its more-than 6,500 unique holders. Unlike NFT 
        launchpads that focus on the launch phase of a collection, as an incubator, Potluck Labs covers 
        ...
        OfficialNFTees has partnered with Potluck labs for Hedera Holiday sweaters, with additional 
        cross-chain collaborations planned in 2023.
            </div>
            <br />
        </>
      );
  ...
  return (
     ...
     const TombModal = () => {
      ...
      const content = (
        ...
        to date. Tombheads has also partnered with many community artists to host mint events, which 
        ...
        favorite contributors across several awards categories. OfficialNFTees partnered with Tombheads 
  ...
  return (
     ...
     const PunkModal = () => {
      ...
      const content = (
        ...
        Labs. FantomPunks, in combination with Gotham Apes, also hosted a first-of-its-kind in-person 
        NFT Auction in Austin, TX during SXSW in March of 2021. TEES and FantomPunks made one of the 
