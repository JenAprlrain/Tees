...
useEffect(() => {
  ...
  return (
    ...
    <div className="physical-shop">
      ...
      <div className="physical-shop-connect-wallet">
  <button className="physical-shop-connect-button" onClick={connectWallet}>
